...
# 1~5
pipex_test 0 "bash: nonexisting: No such file or directory" "nonexisting" "ls" "wc -l" "outfile"
...
pipex_test 0 "bash: infile_permission: Permission denied" "infile_permission" "ls" "wc -l" "outfile"
pipex_test 0 "bash: /usr/bin/sudo: Permission denied" "infile" "sudo" "wc -l" "outfile"
# 
pipex_test 126 "bash: /usr/bin/sudo: Permission denied" "infile" "ls" "sudo" "outfile"
pipex_test 1 "bash: outfile_permission: Permission denied" "infile" "ls" "wc -l" "outfile_permission"
pipex_test 0 "bash: : No such file or directory" "" "ls" "wc -l" "outfile"
pipex_test 0 "'' : command not found" "infile" "" "wc -l" "outfile"
pipex_test 127 "'' : command not found" "infile" "ls" "" "outfile"
# 
pipex_test 1 "bash: : No such file or directory" "infile" "ls" "wc -l" ""
...
pipex_test 0 "bash: /: Is a directory" "infile" "/" "wc -l" "outfile"
pipex_test 126 "bash: /: Is a directory" "infile" "ls" "/" "outfile"
pipex_test 0 "bash: .: filename argument required" "infile" "." "wc -l" "outfile"
# 
pipex_test 2 "bash: .: filename argument required" "infile" "ls" "." "outfile"
pipex_test 0 "" "./lib" "ls" "wc -l" "outfile"
pipex_test 1 "bash: ./lib: Is a directory" "infile" "ls" "wc -l" "./lib"
pipex_test 0 "bash: /usr/bin/lsxx: No such file or directory" "infile" "/usr/bin/lsxx" "wc -l" "outfile"
pipex_test 127 "bash: /usr/bin/lsxx: No such file or directory" "infile" "ls" "/usr/bin/lsxx" "outfile"
# 
rm -f " "
pipex_test 0 "bash:  : No such file or directory" " " "ls -l" "wc -l" "outfile"
pipex_test 0 " : command not found" "infile" " " "wc -l" "outfile"
